...
const NavBar = () => {
  return (
    <nav className="navbar  fixed-top navbar-expand-lg  bg-body-tertiary  animate__animated animate__fadeInDown" style={{backgroundColor:'#233142'}} >
    <div className="container ">
      <a className="navbar-brand" href="#" style={{color:'#66bfbf'}}>Daniel Franchi</a>
        ...
        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item px-2">
           ...
           <li className="py-1 px-2">
            <button className="btn" style={{backgroundColor:'#66bfbf' ,height:'35px',margin:'0 auto',color:'white'}}>Descargar cv</button>
          </li>
        </ul>
      </div>
    </div>
